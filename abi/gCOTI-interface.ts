// Generated TypeScript interface for gCOTI contract
...
export interface GCOTIContract extends ethers.Contract {
  ...
  decreaseAllowance(spender: string, subtractedValue: bigint): Promise<ethers.ContractTransactionResponse>;
  eip712Domain(): Promise<[string, string, string, bigint, string, string, bigint]>;
  increaseAllowance(spender: string, addedValue: bigint): Promise<ethers.ContractTransactionResponse>;
  ...
  permit(owner: string, spender: string, value: bigint, deadline: bigint, v: bigint, r: string, s: string): Promise<ethers.ContractTransactionResponse>;
...
export type GCOTIConstructorParams = {
  initialOwner: string;
  recipient: string;
  totalSupply: bigint;
};

export const GCOTI_ABI = [
  {
    "inputs": [
      {
...
export const GCOTI_BYTECODE = ""; // Add bytecode here if needed

export type DeployGCOTI = (
